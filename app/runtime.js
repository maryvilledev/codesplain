...
let lang_runtime_config = require('lang_runtime_config');

require('lang_cache/runtime_config_modifier.js')(lang_runtime_config);
...
let LexerClass = require('lang_cache/' + lexer_classname + '.js')[lexer_classname];
let ParserClass = require('lang_cache/' + parser_classname + '.js')[parser_classname];

// Loads our custom error listener.
let ErrorListener = require('app/error_listener');

// Loads the transformers
let transformers = require('app/transformers');
